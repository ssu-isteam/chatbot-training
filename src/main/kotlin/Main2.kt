...
fun main2(args: Array<String>) {
   ...
   // packedRawDataSet.rawDataSets = packedRawDataSet.rawDataSets.subList(0, 100)
    /*
    ...
    val model = KerasModelImport.importKerasSequentialModelAndWeights("lstm.h5")

    model.init()

 //   println(model.activate(dataSource.next().features, Layer.TrainingMode.TEST).shapeInfoToString())
