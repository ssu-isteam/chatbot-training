...
public class EncoderDecoderLSTM {
    ...
    private void createComputationGraph() {
        RmsProp updater = new RmsProp(LEARNING_RATE);
        ...
        graphBuilder.addInputs("inputLine", "decoderInput")
                ...
                .addLayer("encoder",
                        new LSTM.Builder().nIn(EMBEDDING_WIDTH).nOut(HIDDEN_LAYER_WIDTH).activation(Activation.TANH).build(),
                        "embeddingEncoder")
                ...
                .addLayer("decoder",
                        new LSTM.Builder().nIn(dict.size() + HIDDEN_LAYER_WIDTH).nOut(HIDDEN_LAYER_WIDTH).activation(Activation.TANH)
                                .build(),
                        "merge")
